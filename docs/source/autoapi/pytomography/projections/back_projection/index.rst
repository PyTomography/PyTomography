...
.. autoapisummary::
   ...
   pytomography.projections.back_projection.BackProjectionNetOld
   pytomography.projections.back_projection.BackProjectionNet




.. py:class:: BackProjectionNetOld(object_correction_nets, image_correction_nets, object_meta, image_meta, device='cpu')
