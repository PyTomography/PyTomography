...
.. autoapisummary::
   ...
   pytomography.io.SPECT.dicom.get_affine_matrix
   pytomography.io.SPECT.dicom._get_affine_spect
...
.. py:function:: get_affine_matrix(filename)


.. py:function:: _get_affine_spect(filename)
...
.. py:function:: save_dcm(save_path, object, file_NM, recon_method_string = '', scale_factor = 1024)
   ...
   :type file_NM: str
   :param recon_method_str: Type of reconstruction performed. Obtained from the `recon_method_str` attribute of a reconstruction algorithm class.
   :type recon_method_str: str
   :param scale_factor: Amount by which to scale output data so that it can be converted into a 16 bit integer. Defaults to 1024.
