...
.. autoapisummary::
   ...
   pytomography.utils.spatial.pad_image
   pytomography.utils.spatial.unpad_image
...
.. py:function:: rotate_detector_z(x, angles, mode = 'bilinear', negative = False)
   ...
   :param mode: Method of interpolation used to get rotated image. Defaults to bilinear.
